...
GID_GLOSSARY <- list(
  ...
  group = list("Group",
    "The species or population block this sample was analyzed within. Samples in different groups are never compared."),
  ...
  log10_LR = list("log10 LR",
    "The strength of evidence, on a log scale: how much better 'one animal sampled twice' explains this pair than 'two different animals'. 0 means the two explanations fit equally well. 4 means one animal fits ten thousand times better. Negative favors two animals."),
  ...
  sethi = list("Sethi et al.", "Likelihood against the best competing relationship, accepted when \u039b > 1."),
